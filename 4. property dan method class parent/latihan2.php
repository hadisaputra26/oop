...
// turunkan class laptop ke dekstop
class dekstop extends laptop {
  
   public function lihat_spec() {
     return "Spec dekstop: Lenovo, 
     Processor Intel core i3, Ram 1GB";
   }
